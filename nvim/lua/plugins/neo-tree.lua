return {
  {
    ...
    lazy = true,
    keys = {
      { "<leader>ef", "<Cmd>Neotree toggle position=right source=filesystem<CR>", desc = "Neotree normal" },
      { "<leader>eg", "<Cmd>Neotree toggle position=float source=git_status<CR>", desc = "Neotree git" },
      -- { "<leader>ed", "<Cmd>Neotree toggle position=right source=document_symbols<CR>", desc = "Neotree doc_symbols" },
      { "<leader>eb", "<Cmd>Neotree toggle position=float source=buffers<CR>", desc = "Neotree buffers" },
    },
    opts = {
      ...
      event_handlers = {
        {
          event = "file_opened", -- auto close neo-tree when after file
      ...
      default_component_configs = {
        ...
        last_modified = {
          ...
          format = "%Y-%m-%d %I:%M %h", -- format string for timestamp (see `:h os.date()`)
